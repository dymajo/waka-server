export default {
  ...
  '186': [['South Lynn Loop']],
  '191': [
    ['Lynfield', 'New Lynn', 'Blockhouse Bay And Avondale'],
    ['New Lynn', 'Lynfield', 'Avondale And Blockhouse Bay'],
  ],
  '195': [
  ...
  '252': [['Lynfield', 'Civic Centre', 'Dominion Rd']],
  '253': [['Blockhouse Bay', 'Civic Centre', 'Dominion Rd']],
  ...
  '314': [['Middlemore Station', 'Ormiston', 'Otara']],
  ...
  '353': [['Manukau Bus Station', 'Botany Town Centre', 'Preston Rd']],
  '355': [
  ...
  '362': [['Manukau Bus Station', 'Weymouth', 'Great South Rd']],
  '363': [['Manurewa Interchange', 'Wattle Downs Loop']],
  '365': [['Manukau Bus Station', 'Papakura Interchange', 'Porchester']],
  '366': [
  ...
  '380': [['Onehunga', 'Manukau Bus Station', 'Airport']],
  ...
  '801': [['Bayswater Wharf', 'Akoranga Station', 'Takapuna']],
  '802': [['Bayswater', 'City (Mayoral Dr)']],
  '806': [['Devonport Wharf', 'Stanley Pt Loop']],
  '807': [['Devonport Wharf', 'Cheltenham Loop']],
  '814': [['Devonport Wharf', 'Akoranga Station', 'Takapuna']],
  '842': [['Crown Hill', 'Smales Farm Station', 'East Coast Rd']],
  '843': [['Akoranga Station', 'Constellation Station', 'Takapuna']],
  '845': [['Milford', 'Takapuna', 'North Shore Hospital']],
  '856': [
    ['Albany Station', 'Takapuna', 'Beach Rd And Milford'],
    ['Takapuna', 'Albany Station', 'Milford And Beach Rd'],
  ],
  '861': [['Long Bay', 'Constellation Station', 'Bush Rd']],
  '865': [['Browns Bay', 'Albany Station', 'Oaktree Ave']],
  '866': [
    ['Albany Stn', 'Newmarket', 'Ponsonby And Auckland Hospital'],
    ['Newmaket', 'Albany Station', 'Auckland Hospital & Ponsonby'],
  ],
  '871': [['Constellation Station', 'Takapuna', 'Forrest Hill Rd']],
  '878': [
    ['Browns Bay', 'Constellation Station', 'and East Coast Rd'],
    ['Browns Bay', 'Constellation Station', 'East Coast Rd'],
  ],
  '883': [['Schnapper Rock', 'Constellation Station']],
  '884': [['Constellation Station', 'NHIE Loop Anticlockwise']],
  '885': [['Constellation Station', 'NHIE Loop Clockwise']],
  '889': [['Albany Station', 'Constellation Station', 'Hugh Green Dr']],
  '890': [['Albany Station To Corinthian Dr Loop']],
  '901': [['Smales Farm', 'Constellation Station', 'Wairau Rd']],
  '906': [
    ['Constellation', 'Smales Farm', 'Windy Ridge And Archers Rd'],
    ['Smales Farm', 'Constellation', 'Archers Rd And Windy Ridge'],
  ],
  '907': [['Campbells Bay', 'Constellation Station', 'Sunnynook Station']],
  '917': [['Birkenhead Wharf', 'Albany Station', 'Glenfield Rd']],
  '923': [['Akoranga Station', 'City (Mayoral Dr)', 'Hillcrest']],
  '924': [['Hillcrest', 'City (Mayoral Dr)']],
  '926': [['Glenfield', 'Akoranga Station', 'Hillcrest West']],
  '928': [['Northcote Point', 'Smales Farm Stn', 'North Shore Hospital']],
  '931': [
    ['Chatswood', 'University Of Auckland', 'Customs St'],
    ['Chatswood', 'Unniversity Of Auckland', 'Customs St'],
  ],
  '933': [['Beach Haven Wharf', 'University Of Auckland', 'Customs St']],
  '939': [['Windy Ridge', 'University of Auckland', 'Customs St']],
  '941': [
  ...
  '981': [['Waiwera', 'Hibiscus Coast Station']],
  '982': [['Gulf Harbour', 'Hibiscus Coast Station']],
  '983': [['Gulf Harbour', 'Hibiscus Coast Station', 'Vipond Rd']],
  '984': [['Orewa', 'Hibiscus Coast Station', 'Maygrove']],
  '985': [['Orewa', 'Hibiscus Coast Station', 'Millwater']],
  '986': [
    ['Hibiscus Coast Station', 'Albany Station', 'Dairy Flat'],
    ['Hibiscus Coast Station', 'Albany Station', 'Dariy Flat'],
  ],
  '987': [['Arkles Bay Loop']],
  '988': [['Gulf Harbour Ferry', 'The Plaza', 'Army Bay']],
  '995': [['Warkworth', 'Hibiscus Coast Station']],
  '996': [['Algies Bay', 'Warkworth', 'Snells Beach']],
  '997': [['Warkworth', 'Omaha', 'Matakana And Port Wells']],
  NX1: [
    ['Britomart (Lower Albert St)', 'Hibiscus Coast Stn'],
    ['Hibiscus Coast Station', 'Britomart (Lower Albert St)'],
  ],
  NX2: [['Auckland Universities', 'Albany Station', 'Wellesley St']],
  ...
  CTY: [['Wynyard Quarter', 'Karangahape Rd', 'Queen St']],
  ...
  '221X': [['Rosebank Rd', 'City Centre', 'New North Rd Express']],
  '223X': [['New Lynn', 'City Centre', 'New North Rd Express']],
  '243X': [['New Lynn', 'City Centre', 'Sandringham Rd Express']],
  '248X': [['Blockhouse Bay', 'City Centre', 'Sandringham Rd Express']],
  '72C': [
